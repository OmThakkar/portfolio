        ...
        <div className="flex items-center gap-1.5">
          {techStack.map((tech) => (
            ...
            >
              <span
                key={index}
                className="p-2 bg-deep-purple-50 dark:bg-deep-purple-50/10 text-deep-purple-900 dark:text-deep-purple-50 rounded-full"
              >
                <tech.icon className="tech-icon" size={16} />
              </span>
            </Tooltip>
          ))}
        </div>
